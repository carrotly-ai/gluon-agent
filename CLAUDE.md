...
The outer loop (docs/design/agent-loops.md): a persistent objective iterated
across runs where **the agent authors the next iteration's tasks** and the
harness keeps authority over verification, budgets, and stopping.
