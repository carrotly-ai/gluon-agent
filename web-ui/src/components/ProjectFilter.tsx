...
export function ProjectFilter({ filter, onFilterChange }: ProjectFilterProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        className="flex items-center gap-2 px-3 py-1.5 text-[0.6875rem] text-[#a3a3a3] hover:text-[#fafaf9] transition-colors bg-[rgba(163,163,163,0.05)] hover:bg-[rgba(163,163,163,0.1)] rounded-sm border border-[rgba(163,163,163,0.1)]"
      ...
      {open && (
        <div className="absolute top-full left-0 mt-1 w-64 max-h-80 overflow-auto bg-[#171717] border border-[rgba(163,163,163,0.15)] rounded-sm shadow-xl z-50">
          {/* All Projects option */}
          <button
            className={cn(
              'w-full px-3 py-2 text-left text-[0.6875rem] hover:bg-[rgba(163,163,163,0.1)] transition-colors flex items-center gap-2',
              filter.type === 'all' ? 'text-[#fafaf9] bg-[rgba(163,163,163,0.08)]' : 'text-[#a3a3a3]'
            )}
